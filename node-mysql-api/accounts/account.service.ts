...
async function register(params: any, origin: any) {
    console.log('REGISTER CALLED:', params.email);
    if (await db.Account.findOne({ where: { email: params.email } })) {
        console.log('EMAIL ALREADY EXISTS - sending already registered email');
        return await sendAlreadyRegisteredEmail(params.email, origin);
    }
    console.log('NEW REGISTRATION - sending verification email');
